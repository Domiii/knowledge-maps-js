...
squishy.UI.MapView.prototype.initMap = function() {
    ...
    (function() {
        ...
        this.map.addEventListener('mousedown',  function(evt) { _this.onTouchStart(evt); } , false);
        
        // move about
        this.map.addEventListener('mousemove',  function(evt) { if (_this.dragAnchor.active) _this.onTouchUpdate(evt); } , false);
